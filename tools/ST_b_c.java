...
public class ST_b_c {
    ...
    public ST_b_c(double ER_square, double ER_intense_status, double PR_square, double HERN2_square, double HERN2_intense_status,
    ...
    public void calculateStatus(){
        ...
        if (this.condition_1() &&  this.condition_2() && this.condition_3()
                && (this.G_value.equals("G1") || this.G_value.equals("G2"))){
            this.isST_a_c = true;
        }
    }
